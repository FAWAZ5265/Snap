...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1619524486,1558668590}
Snap = Config.Snap
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'tft4t')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "tft4t")}},
{{text="᥀ السورس .",url="https://t.me/tft4t"},{text="᥀ لتنصيب بوت .",url="https://t.me/WtttW"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '↯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "tft4t")..')', 1, 'md') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or tft4t}}}
...
Text = [[
Welcome To Source
↯︙[Snap Team](https://t.me/tft4t)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/tft4t"}},
{{text = '᥀ Developer',url="t.me/DODDDPPP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/tft4t&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Snap     --
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "tft4t")..")"
else 
...
os.execute('wget https://raw.githubusercontent.com/FAWAZ5265/Snap/master/Snap.lua') 
dofile('Snap.lua') 
